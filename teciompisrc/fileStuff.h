...
namespace tecplot { namespace ___3934 { typedef std::map<uint16_t, std::string> ___3943; typedef std::map<uint16_t, uint64_t> ___3946; typedef std::map<std::string, std::string> TagDescriptionToDescriptionMap; std::string getFileNameSansFolder(std::string const& ___1392); }}
...
static uint16_t const  ___2850 = 0x0001; static uint16_t const  ___2846 = 0x0002; static uint16_t const  SUBZONE_MAX_I_SIZE_TAG = 0x0003; static uint16_t const  SUBZONE_MAX_J_SIZE_TAG = 0x0004; static uint16_t const  SUBZONE_MAX_K_SIZE_TAG = 0x0005; static uint16_t const  SUBZONE_MAX_FE_SIZE_TAG = 0x0006; static uint16_t const  ___241 = 0x0007; static uint16_t const  ___1579 = 0x0008; static uint16_t const  ___793 = 0x0009; static uint16_t const  ___4084 = 0x000A; static uint16_t const  NUM_PARTITION_FILES_TAG = 0x000B; static uint16_t const  DATA_SET_TITLE_TAG = 0X000C; static uint16_t const  ___4651 = 0x0100; static uint16_t const  ZONE_TYPE_FILE_LOC_TAG = 0x0101; static uint16_t const  ___4630 = 0x0102; static uint16_t const  ___4610 = 0x0103; static uint16_t const  ___4676 = 0x0104; static uint16_t const  ___4686 = 0x0105; static uint16_t const  ___4670 = 0x0106; static uint16_t const  ZONE_IMAX_OR_NUM_NODES_FILE_LOC_TAG = 0x0107; static uint16_t const  ZONE_JMAX_OR_NUM_CELLS_FILE_LOC_TAG = 0x0108; static uint16_t const  ZONE_KMAX_OR_NUM_CORNERS_FILE_LOC_TAG = 0x0109; static uint16_t const  ___4674 = 0x010C; static uint16_t const  ZONE_NUM_SECTIONS_FILE_LOC_TAG = 0x010D; static uint16_t const  ZONE_NUM_ELEMS_PER_SECTION_FILE_LOC_TAG = 0x010E; static uint16_t const  ZONE_CELL_SHAPE_PER_SECTION_FILE_LOC_TAG = 0x010F; static uint16_t const  ZONE_GRID_ORDER_PER_SECTION_FILE_LOC_TAG = 0x0110; static uint16_t const  ZONE_CELL_BASIS_FUNC_PER_SECTION_FILE_LOC_TAG = 0x0111; static uint16_t const  ___4365 = 0x0200; static uint16_t const  VAR_ZONE_MIN_MAX_FILE_LOC_TAG = 0x0300; static uint16_t const  ___4393 = 0x0301; static uint16_t const  ___4384 = 0x0302; static uint16_t const  ___4387 = 0x0303; static uint16_t const  ___4390 = 0x0304;
 #define ___2840 "numTags"
 #define ___3944 "tags"
 ...
 #define ___1652 "xOrThetaPos"
 #define ___1654 "yOrRPos"
 #define ___1657 "zPos"
 ...
 #define ___1653 "xValuesForSegment"
 #define ___1655 "yValuesForSegment"
 #define ___1658 "zValuesForSegment"
 #define ___4137 "xOrThetaPos"
 #define ___4138 "yOrRPos"
 #define ___4141 "zPos"
 #define ___4083 "textColor"
 #define ___4061 "textBoxColor"
 #define ___4063 "textBoxFillColor"
 #define ___4073 "textBoxLineThickness"
 #define ___4075 "textBoxMargin"
 #define TEXT_BOX_TYPE "textBoxType"
 #define ___4045 "textAnchor"
 #define ___4058 "textAngle"
 #define TEXT_CLIPPING "textClipping"
 #define TEXT_HEIGHT "textHeight"
 #define ___4109 "textLineSpacing"
 #define ___4112 "textMacroFunctionCmdLength"
 #define ___4111 "textMacroFunctionCmd"
 #define ___4117 "textPositionCoordSys"
 #define ___4121 "textScope"
 #define ___4126 "textSizeUnits"
 #define ___4129 "textStringLength"
 #define ___4128 "textString"
 #define ___4132 "textTypefaceFamilyLength"
 #define ___4131 "textTypefaceFamily"
 #define ___4134 "textTypefaceIsBold"
 #define ___4136 "textTypefaceIsItalic"
 #define ___4140 "textZoneOrMap"
 #define ___4107 "textIsAttached"
 ...
 (___2850, NUM_ZONES_DESCRIPTION) \
 (___2846, NUM_VARS_DESCRIPTION) \
 ...
 (___4084, TEXT_FILE_LOC_DESCRIPTION) \
...
static uint16_t const ___2785 = 0x0400; static uint16_t const ___2825 = 0x0401;
...
static uint16_t const ___4342 = 0x0600; static uint16_t const ___2726 = 0x0601; static uint16_t const USER_FACE_NBR_FILE_LOC_TAG = 0x0602;
...
static uint16_t const NUM_PARTITIONS_TAG = 0x0700; static uint16_t const PARTITION_FILE_NUM_TAG = 0x0701; static uint16_t const PARTITION_FILE_LOC_TAG = 0x0702; static uint16_t const PARTITION_NUM_CELLS_TAG = 0x0703; static uint16_t const PARTITION_NUM_NODES_TAG = 0x0704; static uint16_t const VAR_PARTITION_MIN_MAX_TAG = 0x0705; static uint16_t const PARTITION_MIN_NODE_NUMBERS_TAG = 0x0706; static uint16_t const PARTITION_MAX_NODE_NUMBERS_TAG = 0x0707;
 ...
 #define ___4689 boost::assign::map_list_of<uint16_t, std::string> \
   \
 ((uint16_t)___2785, NUM_CELL_SUBZONES_DESCRIPTION) \
 ((uint16_t)___2825, NUM_NODE_SUBZONES_DESCRIPTION) \
 ...
 ((uint16_t)___2726, NODE_MAP_FILE_LOC_DESCRIPTION) \
